...
double Factura::getPrecio(){return precio; }

double Factura::getSubtotal(){return subtotal;}

double Factura::getIva(){return iva;}

double Factura::getDescuento(){return descuento;}

double Factura::getTotal(){return total;}
